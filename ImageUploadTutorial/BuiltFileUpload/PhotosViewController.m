...
-(void)loadPhotos{
    ...
    //***********************************************************************************************************
    BuiltClass *builtClass = [[AppDelegate sharedAppDelegate].builtApplication classWithUID:@"userphoto"];
...
-(UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath{
    ...
    BuiltObject *object = [self.photos objectAtIndex:indexPath.row];
    [cell.photoViewImage setImageWithURL:[NSURL URLWithString:[[object objectForKey:@"image_file"]  objectForKey:@"url"]]];
...
-(NSURL *)imageURLAtIndex:(NSInteger)index imageViewer:(MHFacebookImageViewer *)imageViewer{
    BuiltObject *object = [self.photos objectAtIndex:index];

    return [NSURL URLWithString:[[object objectForKey:@"image_file"]  objectForKey:@"url"]];
}
...
-(void)downloadImageAtIndex:(NSInteger)index imageViewer:(MHFacebookImageViewer *)imageViewer {
    BuiltObject *object = [self.photos objectAtIndex:index];

    [[AppDelegate sharedAppDelegate] downloadImage:object onSuccess:^{
